...
export default function EditUserGroup() {
    ...
    const fetchUserGroup = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                alert('Failed to fetch user group data: ' + response.data.message);
            ...
            if (error.response) {
                ...
                alert('Error fetching user group data: ' + (error.response.data.message || error.response.statusText));
            } else {
                alert('Error fetching user group data: Network error or server unavailable');
            }
            navigate('/users/groups');
        } finally {
            setIsFetching(false);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                alert('Error: ' + (response.data.message || 'Failed to update user group'));
            }
        } catch (error) {
            ...
            if (error.response && error.response.data && error.response.data.message) {
                ...
                alert('Error updating user group. Please try again.');
            }
        } finally {
            setLoading(false);
        }
    ...
    return (
        <div className="container-fluid">
            <PageTitle title="Edit User Group" pageTitle="Edit User Group" />
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="d-flex justify-content-end">
                                        ...
                                        <button type="submit" className="btn btn-primary" disabled={loading}>
                                            {loading ? 'Updating...' : 'Update User Group'}
                                        </button>
                                    </div>
                                </form>
                            </div>
