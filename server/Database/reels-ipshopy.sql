-- =====================================================
-- Reels Management System - Complete Database Setup
-- Single file for easy import into XAMPP/phpMyAdmin
-- =====================================================
...
DROP TABLE IF EXISTS `video_approval_logs`;
...
CREATE TABLE `reels` (
    ...
    CONSTRAINT `fk_reels_uploader_id` FOREIGN KEY (`uploader_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_reels_category_id` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE RESTRICT,
    CONSTRAINT `fk_reels_product_id` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE SET NULL,
    CONSTRAINT `fk_reels_brand_id` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`) ON DELETE SET NULL,
    CONSTRAINT `fk_reels_approved_by` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
-- =====================================================
CREATE TABLE `video_approval_logs` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_video_approval_logs_reel_id` FOREIGN KEY (`reel_id`) REFERENCES `reels` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_video_approval_logs_admin_id` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
CREATE TABLE `reel_likes` (
    ...
    CONSTRAINT `fk_reel_likes_reel_id` FOREIGN KEY (`reel_id`) REFERENCES `reels` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_reel_likes_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
-- =====================================================
CREATE INDEX `idx_reels_uploader_status` ON `reels` (`uploader_id`, `status`);
CREATE INDEX `idx_reels_brand_status` ON `reels` (`brand_id`, `status`);
CREATE INDEX `idx_reels_product_status` ON `reels` (`product_id`, `status`);
CREATE INDEX `idx_reels_engagement` ON `reels` (`views`, `likes`, `impressions`);
CREATE INDEX `idx_reels_status_approved_at` ON `reels` (`status`, `approved_at`);
...
INSERT INTO `users` (`email`, `password_hash`, `role`, `first_name`, `last_name`, `phone`, `is_active`, `email_verified_at`) VALUES
...
INSERT INTO `profiles` (`user_id`, `username`, `bio`, `follower_count`, `following_count`, `post_count`) VALUES
(1, 'admin', 'System Administrator', 0, 0, 0);

-- 3. INSERT SAMPLE BRANDS (Optional - for testing)
INSERT INTO `brands` (`name`, `slug`, `description`, `website_url`, `is_active`) VALUES
...
INSERT INTO `products` (`brand_id`, `name`, `slug`, `description`, `sku`, `price`, `is_active`) VALUES
...
INSERT INTO `product_variants` (`product_id`, `variant_name`, `variant_value`, `sku_suffix`, `additional_price`, `stock_quantity`) VALUES
