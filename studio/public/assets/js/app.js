...
class ThemeLayout {
     ...
     changeThemeMode(color) {
          ...
          if (color === 'dark') {
               this.html.classList.remove('topbar-light', 'sidebar-light');
               this.html.classList.add('topbar-dark', 'sidebar-dark');
          } else {
               this.html.classList.remove('topbar-dark', 'sidebar-dark');
               this.html.classList.add('topbar-light', 'sidebar-light');
          }
          
          // Also update the config for topbar and menu colors
          this.config.topbar.color = color === 'dark' ? 'topbar-dark' : 'topbar-light';
          this.config.menu.color = color === 'dark' ? 'sidebar-dark' : 'sidebar-light';
          
          // Dispatch custom event for theme change
          const themeChangeEvent = new CustomEvent('themeChange', { detail: { theme: color } });
